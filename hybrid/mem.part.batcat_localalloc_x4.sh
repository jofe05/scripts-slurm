...
instance_1="numactl --localalloc --physcpubind=0-15"
instance_2="numactl --localalloc --physcpubind=16-31"
instance_3="numactl --localalloc --physcpubind=32-47"
instance_4="numactl --localalloc --physcpubind=48-63"
...
while [ -e /proc/$pid_inst3]; do sleep 0.1; don
#Deleting results 
