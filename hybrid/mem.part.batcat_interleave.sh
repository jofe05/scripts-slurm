...
instance_1="numactl --interleave=0 --physcpubind=0-7"
instance_2="numactl --interleave=1 --physcpubind=8-15"
instance_3="numactl --interleave=2 --physcpubind=16-23"
instance_4="numactl --interleave=3 --physcpubind=24-31"
instance_5="numactl --interleave=4 --physcpubind=32-39"
instance_6="numactl --interleave=5 --physcpubind=40-47"
instance_7="numactl --interleave=6 --physcpubind=48-55"
instance_8="numactl --interleave=7 --physcpubind=56-63"
