...
#### HYBRID_x4 ####
echo "Submitting jobs for BWA-MEM: Batman/Catwoman"
#run $number_runs sbatch mem.part.batcat_x4.sh $file 1 

echo "Submitting jobs for BWA-MEM: Penguin"
#run $number_runs sbatch mem.part.penguin_x4.sh $file 1 

echo "Submitting jobs for BWA-MEM: Batman/Catwoman"
#run $number_runs sbatch mem.part.batcat_interleave_x4.sh $file 1 

echo "Submitting jobs for BWA-MEM: Penguin"
#run $number_runs sbatch mem.part.penguin_interleave_x4.sh $file 1 

echo "Submitting jobs for BWA-MEM: Batman/Catwoman"
#run $number_runs sbatch mem.part.batcat_localalloc_x4.sh $file 1 

echo "Submitting jobs for BWA-MEM: Penguin"
#run $number_runs sbatch mem.part.penguin_localalloc_x4.sh $file 1 
...
#### HYBRID ####
echo "Submitting jobs for Bowtie2: Batman/Catwoman"
run $number_runs sbatch bowtie2.part.batcat_x4.sh $file 1 

echo "Submitting jobs for Bowtie2: Penguin"
#run $number_runs sbatch bowtie2.part.penguin_x4.sh $file 1

echo "Submitting jobs for Bowtie2: Batman/Catwoman"
run $number_runs sbatch bowtie2.part.batcat_interleave_x4.sh $file 1 

echo "Submitting jobs for Bowtie2: Penguin"
#run $number_runs sbatch bowtie2.part.penguin_interleave_x4.sh $file 1

echo "Submitting jobs for Bowtie2: Batman/Catwoman"
run $number_runs sbatch bowtie2.part.batcat_localalloc_x4.sh $file 1 

echo "Submitting jobs for Bowtie2: Penguin"
#run $number_runs sbatch bowtie2.part.penguin_localalloc_x4.sh $file 1
