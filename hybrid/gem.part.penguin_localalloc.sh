...
#instance_1="numactl --localalloc=0 --physcpubind=0,4,8,12,16,20,24,28,32,36,40,44,48,52,56,60"
#instance_2="numactl --localalloc=1 --physcpubind=1,5,9,13,17,21,25,29,33,37,41,45,49,53,57,61"
#instance_3="numactl --localalloc=2 --physcpubind=2,6,10,14,18,22,26,30,34,38,42,46,50,54,58,62"
#instance_4="numactl --localalloc=3 --physcpubind=3,7,11,15,19,23,27,31,35,39,43,47,51,55,59,63"
