...
#SBATCH -o /scratch/077-hpca4se-bioinf/jlenis/logs/journal/scalability/gem_%j.log 
#SBATCH -C "Opteron"
...
echo $OUT_T2
perf stat -e $counters -a --per-socket  -c -r $repeat bin/gem-mapper -t 8 -I $local_index_path/HG_index_GEM/index.gem -i $local_dataset_path/$IN.fastq -o $results_path/$OUT_T2.sam
...
echo $OUT_T3
perf stat -e $counters -a --per-socket  -c -r $repeat  bin/gem-mapper -t 16 -I $local_index_path/HG_index_GEM/index.gem -i $local_dataset_path/$IN.fastq -o $results_path/$OUT_T3.sam
...
echo $OUT_T4
perf stat -e $counters -a --per-socket  -c -r $repeat bin/gem-mapper -t 32 -I $local_index_path/HG_index_GEM/index.gem -i $local_dataset_path/$IN.fastq -o $results_path/$OUT_T4.sam
...
echo $OUT_T5
perf stat -e $counters -a --per-socket  -c -r $repeat bin/gem-mapper -t 48 -I $local_index_path/HG_index_GEM/index.gem -i $local_dataset_path/$IN.fastq -o $results_path/$OUT_T5.sam
...
perf stat -e $counters -a --per-socket  -c -r $repeat bin/gem-mapper -t 64 -I $local_index_path/HG_index_GEM/index.gem -i $local_dataset_path/$IN.fastq  -o $results_path/$OUT_T6.sam
