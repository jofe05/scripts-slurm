...
#SBATCH -o /scratch/077-hpca4se-bioinf/jlenis/logs/journalUpgrade/normal/snap_normal_penguin_%j.log 
...
echo $OUT_T1
perf stat -e $counters ./snap-aligner single $index_path/HG_index_snap $dataset_path/$IN.DUMMY.fastq -t 8 -o $results_path/$OUT_T1.sam
...
perf stat -e $counters ./snap-aligner single $index_path/HG_index_snap $dataset_path/$IN.fastq -t 8 -o $results_path/$OUT_T2.sam
...
echo $OUT_T1
perf stat -e $counters ./snap-aligner single $index_path/HG_index_snap $dataset_path/$IN.DUMMY.fastq -t 16 -o $results_path/$OUT_T1.sam
...
perf stat -e $counters ./snap-aligner single $index_path/HG_index_snap $dataset_path/$IN.fastq -t 16 -o $results_path/$OUT_T3.sam
...
echo $OUT_T1
perf stat -e $counters ./snap-aligner single $index_path/HG_index_snap $dataset_path/$IN.DUMMY.fastq -t 32 -o $results_path/$OUT_T1.sam
...
perf stat -e $counters ./snap-aligner single $index_path/HG_index_snap $dataset_path/$IN.fastq -t 32 -o $results_path/$OUT_T4.sam
...
echo $OUT_T1
perf stat -e $counters ./snap-aligner single $index_path/HG_index_snap $dataset_path/$IN.DUMMY.fastq -t 48 -o $results_path/$OUT_T1.sam
...
perf stat -e $counters ./snap-aligner single $index_path/HG_index_snap $dataset_path/$IN.fastq -t 48 -o $results_path/$OUT_T5.sam
...
echo $OUT_T1
perf stat -e $counters ./snap-aligner single $index_path/HG_index_snap $dataset_path/$IN.DUMMY.fastq -t 64 -o $results_path/$OUT_T1.sam
...
echo $OUT_T6
perf stat -e $counters  ./snap-aligner single $index_path/HG_index_snap $dataset_path/$IN.fastq -t 64 -o $results_path/$OUT_T6.sam
