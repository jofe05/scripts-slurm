...
#SBATCH -o /scratch/077-hpca4se-bioinf/jlenis/logs/journalUpgrade/normal/gem_normal_penguin_%j.log 
...
echo $OUT_T1
perf stat -e $counters  bin/gem-mapper -t 8 -I $index_path/HG_index_GEM/index.gem -i $dataset_path/$IN.DUMMY.fastq -o $results_path/$OUT_T1.sam
...
echo $OUT_T2
perf stat -e $counters  bin/gem-mapper -t 8 -I $index_path/HG_index_GEM/index.gem -i $dataset_path/$IN.fastq -o $results_path/$OUT_T2.sam
...
echo $OUT_T1
perf stat -e $counters  bin/gem-mapper -t 16 -I $index_path/HG_index_GEM/index.gem -i $dataset_path/$IN.DUMMY.fastq -o $results_path/$OUT_T1.sam
...
echo $OUT_T3
perf stat -e $counters   bin/gem-mapper -t 16 -I $index_path/HG_index_GEM/index.gem -i $dataset_path/$IN.fastq -o $results_path/$OUT_T3.sam
...
echo $OUT_T1
perf stat -e $counters  bin/gem-mapper -t 32 -I $index_path/HG_index_GEM/index.gem -i $dataset_path/$IN.DUMMY.fastq -o $results_path/$OUT_T1.sam
...
echo $OUT_T4
perf stat -e $counters  bin/gem-mapper -t 32 -I $index_path/HG_index_GEM/index.gem -i $dataset_path/$IN.fastq -o $results_path/$OUT_T4.sam
...
echo $OUT_T1
perf stat -e $counters  bin/gem-mapper -t 48 -I $index_path/HG_index_GEM/index.gem -i $dataset_path/$IN.DUMMY.fastq -o $results_path/$OUT_T1.sam
...
echo $OUT_T5
perf stat -e $counters  bin/gem-mapper -t 48 -I $index_path/HG_index_GEM/index.gem -i $dataset_path/$IN.fastq -o $results_path/$OUT_T5.sam
...
echo $OUT_T1
perf stat -e $counters  bin/gem-mapper -t 64 -I $index_path/HG_index_GEM/index.gem -i $dataset_path/$IN.DUMMY.fastq -o $results_path/$OUT_T1.sam
...
echo $OUT_T6
perf stat -e $counters  bin/gem-mapper -t 64 -I $index_path/HG_index_GEM/index.gem -i $dataset_path/$IN.fastq  -o $results_path/$OUT_T6.sam
