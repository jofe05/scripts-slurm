...
do
	...
	\time -v ./snap-aligner single $local_index_path/HG_index_snap_1 $local_dataset_path/$IN.DUMMY.fastq -t $num_threads -o $local_results_path/$OUT_T1.sam 2> $log_path/$OUT_T1.txt
...
do
	...
	\time -v ./snap-aligner single $local_index_path/HG_index_snap_1 $local_dataset_path/$IN.fastq -t $num_threads -o $local_results_path/$OUT_T1.sam 2> $log_path/$OUT_T1.txt
