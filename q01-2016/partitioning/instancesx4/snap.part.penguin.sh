...
perf stat -e $counters -c -r $repeat $instance_1 ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.1.fastq -t 16 -o $results_path/$OUT_T2.sam 2> $log_path/$OUT_T2.txt &
#perf stat -e $counters -a --per-socket  -c -r $repeat $instance_1 ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.1.fastq -t 16 -o $results_path/$OUT_T2.sam 2> $log_path/$OUT_T2.txt &
pid_inst1=$!
...
perf stat -e $counters -c -r $repeat $instance_2 ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.2.fastq -t 16 -o $results_path/$OUT_T3.sam 2> $log_path/$OUT_T3.txt &
#perf stat -e $counters -a --per-socket  -c -r $repeat $instance_2 ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.2.fastq -t 16 -o $results_path/$OUT_T3.sam 2> $log_path/$OUT_T3.txt &
...
perf stat -e $counters -c -r $repeat $instance_3 ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.3.fastq -t 16 -o $results_path/$OUT_T4.sam 2> $log_path/$OUT_T4.txt &
#perf stat -e $counters -a --per-socket  -c -r $repeat $instance_3 ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.3.fastq -t 16 -o $results_path/$OUT_T4.sam 2> $log_path/$OUT_T4.txt &
pid_inst3=$!
...
perf stat -e $counters -c -r $repeat $instance_4 ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.4.fastq -t 16 -o $results_path/$OUT_T5.sam 2> $log_path/$OUT_T5.txt 
#perf stat -e $counters -a --per-socket  -c -r $repeat $instance_4 ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.4.fastq -t 16 -o $results_path/$OUT_T5.sam 2> $log_path/$OUT_T5.txt 
