...
echo $OUT_T2
perf stat   -c -r $repeat $socket_1 bwa aln -t 8 $local_index_path/HG_index_BWA_default/hsapiens_v37.fa $local_dataset_path/$IN.fastq > $results_path/$OUT_T2.sam
...
echo $OUT_T3
perf stat   -c -r $repeat $socket_2 bwa aln -t 16 $local_index_path/HG_index_BWA_default/hsapiens_v37.fa $local_dataset_path/$IN.fastq > $results_path/$OUT_T3.sam
...
echo $OUT_T4
perf stat   -c -r $repeat $socket_4 bwa aln -t 32 $local_index_path/HG_index_BWA_default/hsapiens_v37.fa $local_dataset_path/$IN.fastq > $results_path/$OUT_T4.sam
...
echo $OUT_T5
perf stat   -c -r $repeat $socket_6 bwa aln -t 48 $local_index_path/HG_index_BWA_default/hsapiens_v37.fa $local_dataset_path/$IN.fastq > $results_path/$OUT_T5.sam
...
perf stat   -c -r $repeat $socket_all bwa aln -t 64 $local_index_path/HG_index_BWA_default/hsapiens_v37.fa $local_dataset_path/$IN.fastq > $results_path/$OUT_T6.sam
