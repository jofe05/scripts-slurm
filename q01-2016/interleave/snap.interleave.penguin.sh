...
perf stat -e $counters -a --per-socket  -c -r $repeat ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.fastq -t 64 -o $results_path/$OUT_T1.sam
