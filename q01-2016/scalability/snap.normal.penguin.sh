...
#SBATCH --job-name="SNAP-Scalability"
#SBATCH --exclusive
#SBATCH --mem=125G
#SBATCH -w penguin
#SBATCH --time=40:00:00
#SBATCH --partition=p_hpca4se 
#SBATCH -o /scratch/077-hpca4se-bioinf/jlenis/logs/q1-2016/scalability/snap_%j.log 


IN=$1
repeat=$2
TAG="SNAP-Scalability"
num_threads=8
...
perf stat -e $counters -a --per-socket  -c -r $repeat ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.fastq -t 8 -o $results_path/$OUT_T2.sam
...
perf stat -e $counters -a --per-socket  -c -r $repeat ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.fastq -t 16 -o $results_path/$OUT_T3.sam
...
perf stat -e $counters -a --per-socket  -c -r $repeat ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.fastq -t 32 -o $results_path/$OUT_T4.sam
...
perf stat -e $counters -a --per-socket  -c -r $repeat ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.fastq -t 48 -o $results_path/$OUT_T5.sam
...
echo $OUT_T6
perf stat -e $counters -a --per-socket  -c -r $repeat ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.fastq -t 64 -o $results_path/$OUT_T6.sam
