...
perf stat   -c -r $repeat ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.fastq -t 8 -o $results_path/$OUT_T2.sam
...
perf stat   -c -r $repeat ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.fastq -t 16 -o $results_path/$OUT_T3.sam
...
perf stat   -c -r $repeat ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.fastq -t 32 -o $results_path/$OUT_T4.sam
...
perf stat   -c -r $repeat ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.fastq -t 48 -o $results_path/$OUT_T5.sam
...
echo $OUT_T6
perf stat   -c -r $repeat ./snap-aligner single $local_index_path/HG_index_snap $local_dataset_path/$IN.fastq -t 64 -o $results_path/$OUT_T6.sam
