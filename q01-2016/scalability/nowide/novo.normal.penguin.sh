...
echo $OUT_T2
perf stat   -c -r $repeat ./novoalign -c 8 -d $local_index_path/HG_index-Novoalign/hg9.nix -f $local_dataset_path/$IN.fastq -o SAM > $results_path/$OUT_T2.sam
...
perf stat   -c -r $repeat ./novoalign -c 16 -d $local_index_path/HG_index-Novoalign/hg9.nix -f $local_dataset_path/$IN.fastq -o SAM > $results_path/$OUT_T3.sam
...
perf stat   -c -r $repeat ./novoalign -c 32 -d $local_index_path/HG_index-Novoalign/hg9.nix -f $local_dataset_path/$IN.fastq -o SAM > $results_path/$OUT_T4.sam
...
perf stat   -c -r $repeat ./novoalign -c 48 -d $local_index_path/HG_index-Novoalign/hg9.nix -f $local_dataset_path/$IN.fastq -o SAM > $results_path/$OUT_T5.sam
...
perf stat   -c -r $repeat ./novoalign -c 64 -d $local_index_path/HG_index-Novoalign/hg9.nix -f $local_dataset_path/$IN.fastq -o SAM > $results_path/$OUT_T6.sam
